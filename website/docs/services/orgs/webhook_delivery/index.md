...
<tr>
    ...
    <td><a href="#parameter-org"><code>org</code></a>, <a href="#parameter-hook_id"><code>hook_id</code></a>, <a href="#parameter-delivery_id"><code>delivery_id</code></a></td>
    <td></td>
    <td>Returns a delivery for a webhook configured in an organization.<br /><br />You must be an organization owner to use this endpoint.<br /><br />OAuth app tokens and personal access tokens (classic) need `admin:org_hook` scope. OAuth apps cannot list, view, or edit<br />webhooks that they did not create and users cannot list, view, or edit webhooks that were created by OAuth apps.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-org"><code>org</code></a>, <a href="#parameter-hook_id"><code>hook_id</code></a>, <a href="#parameter-delivery_id"><code>delivery_id</code></a></td>
    <td></td>
    <td>Redeliver a delivery for a webhook configured in an organization.<br /><br />You must be an organization owner to use this endpoint.<br /><br />OAuth app tokens and personal access tokens (classic) need `admin:org_hook` scope. OAuth apps cannot list, view, or edit<br />webhooks that they did not create and users cannot list, view, or edit webhooks that were created by OAuth apps.</td>
</tr>
</tbody>
</table>
