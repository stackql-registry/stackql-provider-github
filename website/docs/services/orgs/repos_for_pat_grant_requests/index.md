...
Creates, updates, deletes, gets or lists a <code>repos_for_pat_grant_requests</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="repos_for_pat_grant_requests" /></td></tr>
...
<Tabs
    defaultValue="list_pat_grant_request_repositories"
    values={[
        { label: 'list_pat_grant_request_repositories', value: 'list_pat_grant_request_repositories' }
    ]}
>
<TabItem value="list_pat_grant_request_repositories">
...
<tbody>
<tr>
    <td><a href="#list_pat_grant_request_repositories"><CopyableCode code="list_pat_grant_request_repositories" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-org"><code>org</code></a>, <a href="#parameter-pat_request_id"><code>pat_request_id</code></a></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists the repositories a fine-grained personal access token request is requesting access to.<br /><br />Only GitHub Apps can use this endpoint.</td>
</tr>
</tbody>
</table>
...
Lists the repositories a fine-grained personal access token request is requesting access to.<br /><br />Only GitHub Apps can use this endpoint.
...
FROM github.orgs.repos_for_pat_grant_requests
WHERE org = '{{ org }}' -- required
AND pat_request_id = '{{ pat_request_id }}' -- required
