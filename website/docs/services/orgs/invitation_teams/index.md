...
Creates, updates, deletes, gets or lists an <code>invitation_teams</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="invitation_teams" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.orgs.invitation_teams" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_invitation_teams"
    values={[
        { label: 'list_invitation_teams', value: 'list_invitation_teams' }
    ]}
>
<TabItem value="list_invitation_teams">
...
<tbody>
<tr>
    <td><a href="#list_invitation_teams"><CopyableCode code="list_invitation_teams" /></a></td>
    ...
    <td>List all teams associated with an invitation. In order to see invitations in an organization, the authenticated user must be an organization owner.</td>
</tr>
</tbody>
</table>
