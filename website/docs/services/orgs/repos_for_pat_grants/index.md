...
Creates, updates, deletes, gets or lists a <code>repos_for_pat_grants</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="repos_for_pat_grants" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.orgs.repos_for_pat_grants" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_pat_grant_repositories"
    values={[
        { label: 'list_pat_grant_repositories', value: 'list_pat_grant_repositories' }
    ]}
>
<TabItem value="list_pat_grant_repositories">
...
<tbody>
<tr>
    <td><a href="#list_pat_grant_repositories"><CopyableCode code="list_pat_grant_repositories" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-org"><code>org</code></a>, <a href="#parameter-pat_id"><code>pat_id</code></a></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists the repositories a fine-grained personal access token has access to.<br /><br />Only GitHub Apps can use this endpoint.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-pat_id">
    ...
    <td><code>integer</code></td>
    <td>Unique identifier of the fine-grained personal access token.</td>
</tr>
...
Lists the repositories a fine-grained personal access token has access to.<br /><br />Only GitHub Apps can use this endpoint.
