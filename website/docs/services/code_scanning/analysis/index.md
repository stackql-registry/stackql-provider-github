...
|:-----|:---------|:------------|
| <CopyableCode code="id" /> | `integer` | Unique identifier for this analysis. |
...
| <CopyableCode code="commit_sha" /> | `string` | The SHA of the commit to which the analysis you are uploading relates. |
| <CopyableCode code="created_at" /> | `string` | The time that the analysis was created in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. |
| <CopyableCode code="deletable" /> | `boolean` |  |
| <CopyableCode code="environment" /> | `string` | Identifies the variable values associated with the environment in which this analysis was performed. |
