...
Creates, updates, deletes, gets or lists a <code>followers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="followers" /></td></tr>
...
<Tabs
    defaultValue="list_followers_for_user"
    values={[
        { label: 'list_followers_for_user', value: 'list_followers_for_user' },
        { label: 'list_followers_for_authenticated_user', value: 'list_followers_for_authenticated_user' }
    ]}
>
<TabItem value="list_followers_for_user">
...
<TabItem value="list_followers_for_authenticated_user">
...
<tbody>
<tr>
    <td><a href="#list_followers_for_user"><CopyableCode code="list_followers_for_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-username"><code>username</code></a></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists the people following the specified user.</td>
</tr>
<tr>
    <td><a href="#list_followers_for_authenticated_user"><CopyableCode code="list_followers_for_authenticated_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists the people following the authenticated user.</td>
</tr>
</tbody>
</table>
