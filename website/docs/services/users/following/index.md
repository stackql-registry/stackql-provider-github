...
Creates, updates, deletes, gets or lists a <code>following</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="following" /></td></tr>
...
<Tabs
    defaultValue="list_following_for_user"
    values={[
        { label: 'list_following_for_user', value: 'list_following_for_user' },
        { label: 'list_followed_by_authenticated_user', value: 'list_followed_by_authenticated_user' }
    ]}
>
<TabItem value="list_following_for_user">
...
<TabItem value="list_followed_by_authenticated_user">
...
<tbody>
<tr>
    <td><a href="#list_following_for_user"><CopyableCode code="list_following_for_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-username"><code>username</code></a></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists the people who the specified user follows.</td>
</tr>
<tr>
    <td><a href="#list_followed_by_authenticated_user"><CopyableCode code="list_followed_by_authenticated_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists the people who the authenticated user follows.</td>
</tr>
<tr>
    <td><a href="#check_person_is_followed_by_authenticated"><CopyableCode code="check_person_is_followed_by_authenticated" /></a></td>
...
<tr>
    <td><a href="#follow"><CopyableCode code="follow" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-username"><code>username</code></a></td>
    <td></td>
    <td>Note that you'll need to set `Content-Length` to zero when calling out to this endpoint. For more information, see "[HTTP verbs](https://docs.github.com/rest/guides/getting-started-with-the-rest-api#http-method)."<br /><br />OAuth app tokens and personal access tokens (classic) need the `user:follow` scope to use this endpoint.</td>
</tr>
<tr>
    <td><a href="#unfollow"><CopyableCode code="unfollow" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-username"><code>username</code></a></td>
    <td></td>
    <td>OAuth app tokens and personal access tokens (classic) need the `user:follow` scope to use this endpoint.</td>
</tr>
<tr>
    <td><a href="#check_following_for_user"><CopyableCode code="check_following_for_user" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-username"><code>username</code></a>, <a href="#parameter-target_user"><code>target_user</code></a></td>
    <td></td>
    <td></td>
</tr>
</tbody>
...
<tbody>
<tr id="parameter-target_user">
    <td><CopyableCode code="target_user" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
...
<Tabs
    defaultValue="check_person_is_followed_by_authenticated"
    values={[
        { label: 'check_person_is_followed_by_authenticated', value: 'check_person_is_followed_by_authenticated' },
        { label: 'follow', value: 'follow' },
        { label: 'unfollow', value: 'unfollow' },
        { label: 'check_following_for_user', value: 'check_following_for_user' }
    ]}
>
<TabItem value="check_person_is_followed_by_authenticated">
...
Note that you'll need to set `Content-Length` to zero when calling out to this endpoint. For more information, see "[HTTP verbs](https://docs.github.com/rest/guides/getting-started-with-the-rest-api#http-method)."<br /><br />OAuth app tokens and personal access tokens (classic) need the `user:follow` scope to use this endpoint.
...
<TabItem value="check_following_for_user">
