--- 
title: org_copilot_seats_teams
hide_title: false
hide_table_of_contents: false
keywords:
  - org_copilot_seats_teams
  - copilot
  - github
...
Creates, updates, deletes, gets or lists an <code>org_copilot_seats_teams</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="org_copilot_seats_teams" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.copilot.org_copilot_seats_teams" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#add_copilot_seats_for_teams"><CopyableCode code="add_copilot_seats_for_teams" /></a></td>
...
<Tabs
    defaultValue="add_copilot_seats_for_teams"
    values={[
        { label: 'add_copilot_seats_for_teams', value: 'add_copilot_seats_for_teams' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="add_copilot_seats_for_teams">
...
```sql
INSERT INTO github.copilot.org_copilot_seats_teams (
selected_teams,
org
)
SELECT 
...
- name: org_copilot_seats_teams
  props:
    - name: org
      value: "{{ org }}"
      description: Required parameter for the org_copilot_seats_teams resource.
    - name: selected_teams
      value:
        - "{{ selected_teams }}"
      description: |
