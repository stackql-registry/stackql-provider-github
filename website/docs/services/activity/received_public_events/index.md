...
Creates, updates, deletes, gets or lists a <code>received_public_events</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="received_public_events" /></td></tr>
...
<Tabs
    defaultValue="list_received_public_events_for_user"
    values={[
        { label: 'list_received_public_events_for_user', value: 'list_received_public_events_for_user' }
    ]}
>
<TabItem value="list_received_public_events_for_user">
...
<tbody>
<tr>
    <td><a href="#list_received_public_events_for_user"><CopyableCode code="list_received_public_events_for_user" /></a></td>
...
repo,
type
FROM github.activity.received_public_events
