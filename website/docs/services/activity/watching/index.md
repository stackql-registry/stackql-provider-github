...
Creates, updates, deletes, gets or lists a <code>watching</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="watching" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.activity.watching" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_repos_watched_by_user"
    values={[
        { label: 'list_repos_watched_by_user', value: 'list_repos_watched_by_user' },
        { label: 'list_watched_repos_for_authenticated_user', value: 'list_watched_repos_for_authenticated_user' }
    ]}
>
<TabItem value="list_repos_watched_by_user">
...
<TabItem value="list_watched_repos_for_authenticated_user">
...
<tbody>
<tr>
    <td><a href="#list_repos_watched_by_user"><CopyableCode code="list_repos_watched_by_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-username"><code>username</code></a></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists repositories a user is watching.</td>
</tr>
<tr>
    <td><a href="#list_watched_repos_for_authenticated_user"><CopyableCode code="list_watched_repos_for_authenticated_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td></td>
    <td><a href="#parameter-per_page"><code>per_page</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td>Lists repositories the authenticated user is watching.</td>
</tr>
</tbody>
</table>
