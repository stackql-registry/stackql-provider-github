--- 
title: enterprise_team_organization_bulk_additions
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>enterprise_team_organization_bulk_additions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="enterprise_team_organization_bulk_additions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.enterprise_team_organizations.enterprise_team_organization_bulk_additions" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#bulk_add"><CopyableCode code="bulk_add" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-enterprise"><code>enterprise</code></a>, <a href="#parameter-enterprise-team"><code>enterprise-team</code></a>, <a href="#parameter-organization_slugs"><code>organization_slugs</code></a></td>
    <td></td>
    <td>Assign an enterprise team to multiple organizations.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="bulk_add"
    values={[
        { label: 'bulk_add', value: 'bulk_add' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="bulk_add">
