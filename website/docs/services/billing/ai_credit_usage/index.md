...
Creates, updates, deletes, gets or lists an <code>ai_credit_usage</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ai_credit_usage" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.billing.ai_credit_usage" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_github_billing_ai_credit_usage_report_user"
    values={[
        { label: 'get_github_billing_ai_credit_usage_report_user', value: 'get_github_billing_ai_credit_usage_report_user' }
    ]}
>
<TabItem value="get_github_billing_ai_credit_usage_report_user">
...
<tbody>
<tr>
    <td><a href="#get_github_billing_ai_credit_usage_report_user"><CopyableCode code="get_github_billing_ai_credit_usage_report_user" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-username"><code>username</code></a></td>
    <td><a href="#parameter-year"><code>year</code></a>, <a href="#parameter-month"><code>month</code></a>, <a href="#parameter-day"><code>day</code></a>, <a href="#parameter-model"><code>model</code></a>, <a href="#parameter-product"><code>product</code></a></td>
    <td>Gets a report of AI credit usage for a user.<br /><br />**Note:** Only data from the past 24 months is accessible via this endpoint.</td>
</tr>
</tbody>
</table>
...
Gets a report of AI credit usage for a user.<br /><br />**Note:** Only data from the past 24 months is accessible via this endpoint.
