--- 
title: issue_blocked_by_dependencies
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>issue_blocked_by_dependencies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="issue_blocked_by_dependencies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="github.issues.issue_blocked_by_dependencies" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="list_dependencies_blocked_by"
    values={[
        { label: 'list_dependencies_blocked_by', value: 'list_dependencies_blocked_by' }
    ]}
>
<TabItem value="list_dependencies_blocked_by">
...
<tbody>
<tr>
    <td><a href="#list_dependencies_blocked_by"><CopyableCode code="list_dependencies_blocked_by" /></a></td>
...
<tr id="parameter-issue_id">
    ...
    <td><code>integer</code></td>
    <td>The id of the blocking issue to remove as a dependency</td>
</tr>
...
<Tabs
    defaultValue="add_blocked_by_dependency"
    values={[
        { label: 'add_blocked_by_dependency', value: 'add_blocked_by_dependency' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="add_blocked_by_dependency">
...
<Tabs
    defaultValue="remove_dependency_blocked_by"
    values={[
        { label: 'remove_dependency_blocked_by', value: 'remove_dependency_blocked_by' }
    ]}
>
<TabItem value="remove_dependency_blocked_by">
