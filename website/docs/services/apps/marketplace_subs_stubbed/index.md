...
Creates, updates, deletes, gets or lists a <code>marketplace_subs_stubbed</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="marketplace_subs_stubbed" /></td></tr>
...
<Tabs
    defaultValue="get_subscription_plan_for_account_stubbed"
    values={[
        { label: 'get_subscription_plan_for_account_stubbed', value: 'get_subscription_plan_for_account_stubbed' },
        { label: 'list_accounts_for_plan_stubbed', value: 'list_accounts_for_plan_stubbed' }
    ]}
>
<TabItem value="get_subscription_plan_for_account_stubbed">
...
<TabItem value="list_accounts_for_plan_stubbed">
...
<tbody>
<tr>
    <td><a href="#get_subscription_plan_for_account_stubbed"><CopyableCode code="get_subscription_plan_for_account_stubbed" /></a></td>
...
<tr>
    <td><a href="#list_accounts_for_plan_stubbed"><CopyableCode code="list_accounts_for_plan_stubbed" /></a></td>
    <td><CopyableCode code="select" /></td>
